...
import com.example.util.VirtualKeypad;
...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    public static VirtualKeypad m_virtualKeypad;
    public  static boolean  m_addVirtualKeypad = false;

    public static void enableVirtualKeypad(boolean value)
    {
        if(value == false && m_addVirtualKeypad == true)
        {
            mLayout.removeView(m_virtualKeypad.GetView());
            m_addVirtualKeypad = false;
        }
        else if(value == true && m_addVirtualKeypad == false)
        {
            mLayout.addView(m_virtualKeypad.GetView());
            m_addVirtualKeypad = true;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_virtualKeypad = new VirtualKeypad(this, mLayout);
        m_addVirtualKeypad = true;
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public boolean onKey(View  v, int keyCode, KeyEvent event) {
        ...
        if ((source & InputDevice.SOURCE_KEYBOARD) != 0) {
            ...
            SDLActivity.enableVirtualKeypad(false);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        SDLActivity.enableVirtualKeypad(true);
